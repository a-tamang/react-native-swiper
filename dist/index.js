...
module.exports = _react2.default.createClass({
  ...
  propTypes: {
    ...
    heightArray: _react2.default.PropTypes.array
  },
  ...
  renderButtons: function renderButtons() {
    return _react2.default.createElement(
      _reactNative.View,
      { pointerEvents: 'box-none', style: [styles.buttonWrapper, { width: this.state.width }, this.props.buttonWrapperStyle] },
  ...
  render: function render() {
    ...
    var pages = [];
    var pageStyle = [{ width: state.width }, styles.slide];
